...
-- Generated: 2026-02-02T16:09:49.424Z
-- Tables: 14
...
CREATE TABLE "Escrow" (
  ...
  "updatedAt" timestamp without time zone NOT NULL,
  "jobId" integer NOT NULL,
  "status" USER-DEFINED NOT NULL DEFAULT 'PENDING'::"EscrowStatus",
  "amount" numeric
);
...
CREATE TABLE "Service" (
  ...
  "approvalStatus" USER-DEFINED NOT NULL DEFAULT 'PENDING'::"ApprovalStatus",
...
CREATE TABLE "Session" (
  ...
  "refreshTokenExpiresAt" timestamp without time zone NOT NULL,
...
CREATE TABLE "Withdrawal" (
  ...
  "freelancerId" integer NOT NULL,
  "amount" numeric NOT NULL,
  "status" USER-DEFINED NOT NULL DEFAULT 'PENDING'::"WithdrawalStatus",
