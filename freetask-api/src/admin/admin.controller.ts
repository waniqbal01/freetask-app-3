...
export class AdminController {
    ...
    async rejectService(
        ...
        return this.adminService.rejectService(serviceId, dto.reason, req.user.userId);
    }
    ...
    async rejectWithdrawal(
        ...
        return this.adminService.rejectWithdrawal(withdrawalId, dto.reason || 'No reason provided', req.user.userId);
    }
